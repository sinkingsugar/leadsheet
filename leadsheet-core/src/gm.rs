...
pub const PROGRAM_NAMES: [&str; 128] = [
    ...
    "square_lead", "sawtooth_lead", "calliope_lead", "chiff_lead",
    "charang_lead", "voice_lead", "fifths_lead", "bass_and_lead",
    "new_age_pad", "warm_pad", "polysynth_pad", "choir_pad",
    "bowed_pad", "metallic_pad", "halo_pad", "sweep_pad",
    "rain_fx", "soundtrack_fx", "crystal_fx", "atmosphere_fx",
    "brightness_fx", "goblins_fx", "echoes_fx", "sci_fi_fx",
...
pub fn program_for_label(label: &str) -> Option<u8> {
    ...
    const ALIASES: &[(&str, u8)] = &[
        ("grand_piano", 0), ("electric_piano", 4), ("piano", 0),
        ("rhodes", 4), ("keys", 0),
        ("organ", 16), ("accordion", 21), ("harmonica", 22),
        ("nylon", 24), ("acoustic_guitar", 25), ("clean", 27),
        ("overdrive", 29), ("distort", 30), ("guitar", 25),
        ("acoustic_bass", 32), ("upright", 32), ("synth_bass", 38), ("bass", 33),
        ("violin", 40), ("viola", 41), ("cello", 42),
        ("string", 48), ("harp", 46), ("timpani", 47),
        ("choir", 52), ("voice", 53), ("vocal", 52),
        ("trumpet", 56), ("trombone", 57), ("tuba", 58), ("horn", 60), ("brass", 61),
        ("sax", 65), ("oboe", 68), ("clarinet", 71), ("flute", 73),
        ("lead", 81), ("pad", 89), ("synth", 81),
        ("vibraphone", 11), ("marimba", 12), ("xylophone", 13), ("bell", 14),
        ("sitar", 104), ("banjo", 105),
    ];
